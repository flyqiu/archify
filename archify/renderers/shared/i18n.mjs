...
const MESSAGE_PAIRS = {
  ...
  'viewer.export.page': ['Full diagram page', '完整图表页'],
  'viewer.export.pageHint': ['Title + diagram + cards, no UI', '标题+图表+卡片，不含界面控件'],
  'viewer.export.downloadedPage': ['Full page downloaded', '完整页已下载'],
